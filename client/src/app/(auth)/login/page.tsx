  ...
  return  (
    ...
    <div className="flex w-full border max-w-sm mx-auto overflow-hidden  rounded-lg shadow-lg  lg:max-w-4xl">
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <a  href="#" className="flex items-center justify-center mt-4  transition-colors duration-300 transform border rounded-lg  hover:bg-gray-50 ">
            ...
            <div className="flex items-center justify-between mt-4">
                ...
                <Link href='/register' className="text-xs  uppercase  hover:underline text-rose-500">or sign up</Link>
